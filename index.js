/**
 * A+ CHAOS ID: V124 (FINAL RE-LOCK)
 * STATUS: Identity Re-Embedded. Stable.
 * OWNER: Admin Agent (ID: N054...)
 */
...
// ==========================================
// 1. CORE IDENTITY (YOUR DNA RE-EMBEDDED)
// ==========================================
const Users = new Map();
...
try {
    ...
    console.log(">>> [SYSTEM] IDENTITY RESTORED. ADMIN LOCKED.");
...
app.post('/api/v1/auth/reset', (req, res) => { 
    Users.clear(); 
    console.log(">>> [SYSTEM] MANUAL RESET: MEMORY WIPED.");
...
app.post('/api/v1/auth/login-verify', async (req, res) => {
    ...
    try {
        ...
        if (verification.verified) {
            ...
            adminSession.set(token, { user: 'Admin', level: 'High' }); // Store in AdminSession for Overwatch access
